...
export async function getDashboard(eventId) {
  const [event, teams, presence, helpRequests, recentExecutions, trainingExecutions, tokenLogs] = await Promise.all([
    ...
    listExecutions({ event_id: eventId, limit: 500 }),
    listExecutions({ event_id: eventId, mission_id: "__training__", limit: 5000 }),
