...
alter table public.team_presence            replica identity full;
alter table public.executions               replica identity full;
alter table public.token_operational_logs   replica identity full;
...
alter publication supabase_realtime add table public.token_operational_logs;
